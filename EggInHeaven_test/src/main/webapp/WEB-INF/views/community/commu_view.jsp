...
<script src="../resources/js/view2.js" charset="UTF-8"></script>
<style>
h1 {
...
<body>
	<div class="container">
		...
		<h1>
			<c:out value="${commudata.commu_subject}" />
		</h1>
		...
		<div>
			<p>
				[ 작성자 ]<span id="member_id">  ${commudata.member_id}</span>
			</p>
		...
		<div style="padding-right: 0px">
			<textarea class="form-control" rows="5" readOnly>${commudata.commu_content}</textarea>
		</div>
		<hr>
		<b> <a href="list">
		...
		<c:if test="${commudata.member_id == pinfo.username || pinfo.username == 'admin' }">
		<a href="modifyView?num=${commudata.commu_num}">
				<button type="button" class="btn btn-warning">수정</button>
		</a> <%-- href의 주소를 #으로 설정합니다. --%> <a href="#">
		...
		<div id="comment">
			...
			<textarea rows=3 class="form-control" id="content" maxLength="100"
				placeholder="댓글을 입력해주세요"></textarea>
			<table class="table table-striped">
				<button class="btn btn-outline-primary float-left">총
					100자까지 가능합니다.</button>
