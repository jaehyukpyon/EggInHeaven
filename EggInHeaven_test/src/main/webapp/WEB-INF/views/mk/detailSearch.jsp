			...
			<div class="parent">
				<div class="dropdown">
					...
					<div class="dropdown-content">
						...
						<div>
							소세지<input type="checkbox" name="1" value="소세지" class="ckbox">
						</div>
						<div>
							양고기 <input type="checkbox" name="1" value="양고기" class="ckbox">
						</div>
					</div>
				</div>
				<div class="dropdown">
					...
					<div class="dropdown-content">
						<div>
							생선 <input type="checkbox" name="2" value="생선" class="ckbox">
						</div>
						<div>
							조개류 <input type="checkbox" name="2" value="조개류" class="ckbox">
						</div>
						<div>
							갑각류 <input type="checkbox" name="2" value="갑각류" class="ckbox">
						</div>
						<div>
							오징어 <input type="checkbox" name="2" value="오징어" class="ckbox">
						</div>
						<div>
							해조류 <input type="checkbox" name="2" value="해조류" class="ckbox">
						</div>
					</div>
				</div>
				<div class="dropdown">
					...
					<div class="dropdown-content">
						...
						<div>
							토마토 <input type="checkbox" name="3" value="토마토" class="ckbox">
						</div>
						<div>
							마늘 <input type="checkbox" name="3" value="마늘" class="ckbox">
						</div>
				...
				<div class="dropdown">
					<button class="dropbtn btn btn-primary btn-block" name="5">곡
						류</button>
					<div class="dropdown-content">
						<div>
						...
						<div>
							검은깨 <input type="checkbox" name="5" value="검은깨" class="ckbox">
						</div>

						<div>
							찹쌀 <input type="checkbox" name="5" value="찹쌀" class="ckbox">
						</div>
					</div>
				</div>
