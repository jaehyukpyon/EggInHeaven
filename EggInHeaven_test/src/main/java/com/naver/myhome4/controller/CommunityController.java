...
public class CommunityController {
	...
	public ModelAndView commuList(@RequestParam(value = "page", defaultValue = "1", required = false) int page,
			ModelAndView mv, @RequestParam(value = "search_field", defaultValue = "", required = false) String index,
	...
	public ModelAndView mycommuList(@RequestParam(value = "page", defaultValue = "1", required = false) int page,
			ModelAndView mv, Principal principal) {

		int limit = 10; // 한 화면에 출력할 레코드 갯수

		int listcount = communityService.getMyListCount(principal.getName()); // 총 리스트 수 받아옴
		...
		List<Community> commulist = communityService.getMyCommuList(page, limit, principal.getName()); // 리스트를 받아옴
	...
	public String add(Community community, HttpServletRequest request) throws Exception {
	...
	public ModelAndView CommunityModifyView(int num, ModelAndView mv, HttpServletRequest request) {
	...
	public String CommunityModifyAction(Community commudata, String check, Model mv, HttpServletRequest request,
			RedirectAttributes rattr) throws Exception {
		boolean usercheck = communityService.isCommunityWriter(commudata.getCommu_num(), commudata.getCommu_pass());
		String url = "";
		// 비밀번호가 다른경우
		if (usercheck == false) {
	...
	@PostMapping("/delete")
	public String CommunityDeleteAction(String commu_pass, int num, Model mv, HttpServletRequest request,
